...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleUpdateTime = (TextView) findViewById(R.id.titel_update_time);
        degreeText = (TextView) findViewById(R.id.date_text);
...
//            String weatherId = getIntent().getStringExtra("weather_id");     //没有自动刷新
    ...
    private void showWeatherInfo(Weather weather){
        ...
        String sport = "洗车指数：" + weather.suggestion.sport.info;
